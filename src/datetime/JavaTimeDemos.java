...
public class JavaTimeDemos {
    ...
    public static void main(String[] args) {
        ...
        LocalDate groundHogDay = LocalDate.of(2018, Month.FEBRUARY, 2);
        System.out.printf("Groundhog Day, 2018: %s%n", groundHogDay);

        LocalDate firstDayOfSpring = LocalDate.of(2018, Month.MARCH, 20);
        System.out.printf("First day of Spring 2018: %s%n", firstDayOfSpring);
        ...
        System.out.printf("Total number of time zones: %d%n", availableTimeZones.size());
        availableTimeZones.stream()
                .filter(name -> name.contains("America")).forEach(System.out::println);

        ZonedDateTime missing = ZonedDateTime.of(LocalDate.of(2015, Month.MARCH, 8),
                LocalTime.of(2,30),  // skipped by daylight savings
                ZoneId.of("America/Chicago"));
        System.out.println(missing);

        ZonedDateTime spring = ZonedDateTime.of(2015,3,20,0,0,0,0, ZoneId.systemDefault());
